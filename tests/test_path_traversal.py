...
def assert_path_traversal_is_rejected(client, sock, key):
...
def test_path_traversal_is_rejected(secure_connection):
    client, sock, key = secure_connection
    assert_path_traversal_is_rejected(client, sock, key)
